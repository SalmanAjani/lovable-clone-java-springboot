...
import com.salman.ajani.lovable_clone.service.PaymentProcessor;
...
public class StripePaymentProcessor implements PaymentProcessor {
    ...
    public PortalResponse openCustomerPortal() {
        ...
        if (stripeCustomerId == null || stripeCustomerId.isEmpty()) {
            throw new BadRequestException("User does not have a Stripe customer ID: " + stripeCustomerId);
        }
    ...
    public void handleWebhookEvent(String type, StripeObject stripeObject, Map<String, String> metadata) {
        ...
        switch (type) {
            case "checkout.session.completed" ->
                    handleSessionCompleted((Session) stripeObject, metadata); // one-time, on checkout completed
